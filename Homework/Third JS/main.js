...
let newConsoleLog = function () {
	let nowTimeDate = new Date();
	originConsoleLog(nowTimeDate + ' User ' + this.lastOperation + ' stack value: ' + this.lastOperationValue);
};
window.console.log = newConsoleLog.bind(stack);